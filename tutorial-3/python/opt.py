...
def parse():
    ...
    parser.add_argument('--test_num', type=int, default=100, help='Set number of test data')
    ...
    parser.add_argument('--test_batchsize', type=int, default=25, help='Set test batchsize')
