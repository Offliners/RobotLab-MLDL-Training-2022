...
def parse():
    ...
    parser.add_argument('--max_timestep_test', type=int, default=1000, help='Set maximum of testing timestep')
    parser.add_argument('--step', type=int, default=512, help='Set number of steps to run for each environment')
    parser.add_argument('--episode', type=int, default=10, help='Set number of episode')
    parser.add_argument('--lr', type=float, default=1e-5, help='Set learning rate')
