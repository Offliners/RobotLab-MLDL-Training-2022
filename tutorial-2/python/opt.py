...
def parse():
    ...
    parser.add_argument('--epoch', type=int, default=600, help='Set training epochs')
    ...
    parser.add_argument('--lr_patience', type=int, default=10, help='Set patience of learning rate')
    ...
    parser.add_argument('--early_stop', type=int, default=50, help='Set epoch of early stopping')
