...
def parse():
    ...
    parser.add_argument('--epoch', type=int, default=80, help='Set training epochs')
    parser.add_argument('--alpha', default=0.4, type=float, help='mixup interpolation coefficient (default: 1)')
    parser.add_argument('--model_name', type=str, default='resnet18', help='Set name of model')
