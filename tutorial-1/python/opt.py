...
def parse():
    ...
    parser.add_argument('--train_batchsize', type=int, default=256, help='Set training batchsize')
    parser.add_argument('--val_batchsize', type=int, default=256, help='Set validation batchsize')
    ...
    parser.add_argument('--early_stop', type=int, default=500, help='Set epoch of early stopping')
